...
class LRWarmupWrapper:
    """Wraps the standard PyTorch LR scheduler to support warmup.
    ...
    def __init__(self, torch_scheduler: _LRScheduler, warmup_steps: int = 0, warmup_factor: float = 0.1):
        """
        Args:
            torch_scheduler: An instance of torch.optim.lr_scheduler._LRScheduler
            warmup_steps: Number of update steps in warmup stage.
            warmup_factor: The factor of initial warmup lr relative to base lr. Defaults to 0.1.
        """
